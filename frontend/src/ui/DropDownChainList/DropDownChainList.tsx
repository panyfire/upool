...
export const DropDownChainList: FC<IButton> = (props) => {
  ...
  const chainIDS = [
    ...
    },
    {
      ...
      rpcUrls: ['https://arbitrum-mainnet.infura.io/v3/YOUR_INFURA_KEY'],
    ...
    },
    {
      ...
      rpcUrls: ['https://optimism-mainnet.infura.io/v3/YOUR_INFURA_KEY'],
    ...
    },
    {
      ...
      rpcUrls: [
        'https://linea-goerli.infura.io/v3/02792ae49747452b85ca01aa16981682',
      ], // List of RPC endpoints
      blockExplorerUrls: ['https://etherscan.io'], // List of block explorer URLs,
      iconUrls: ['https://path.to.your.icon.eth'],
    },
